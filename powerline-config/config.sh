...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="35.482339213631825"
	TMUX_POWERLINE_SEG_AIR_LON="-82.53935366945655"
	# Your Open Weather API Key:
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="63c1ce78b1b8c29e4b47ba97aceaf6c1"
# }
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/pj/5b5v9dqn1v96x41tglrqlk5r0000gq/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/finnisj/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/finnisj/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	export TMUX_POWERLINE_SEG_NOW_PLAYING_ROLL_SPEED="4"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="35.482339213631825"
	TMUX_POWERLINE_SEG_WEATHER_LON="-82.53935366945655"
# }
